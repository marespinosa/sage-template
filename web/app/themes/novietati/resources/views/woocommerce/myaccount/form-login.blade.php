...
$enable_myaccount_registration = 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ?? false;

?>

<?php if ( $enable_myaccount_registration ) : ?>
...
<div class="u-columns col2-set" id="customer_login">
    ...
    <div class="u-column1 col-1">
        ...
        <div
            class=" {!! $enable_myaccount_registration ? 'enable-myaccount-registration' : 'enable-only-login mx-auto'  !!} ">

            <h2 class="woocommerce-entry-title text-center">
            ...
            <form class="woocommerce-form woocommerce-form-login login" method="post">
                ...
                <p class="mb-3">
                    <label for="username" class=" block mb-1 ">
                        <?php esc_html_e( 'Username or email address', 'woocommerce' ); ?>&nbsp;<span
                            class="required color-warning  text-xl">*</span>
                    </label>
                ...
                <p class="mb-6">
                    <label for="password" class=" block mb-1 ">
                        ...
                        <span class="required color-warning  text-xl">*</span>
                    </label>
                ...
                <small class="woocommerce-LostPassword lost_password text-center block">
                    <a href="<?php echo esc_url( wp_lostpassword_url() ); ?>" class="link-on-hover">

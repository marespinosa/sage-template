...
<div class="flex items-start mb-12 xl:mb-20 flex-wrap xl:flex-nowrap">

    <form class="woocommerce-cart-form mb-9 xl:mb-0" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
...
<?php woocommerce_cross_sell_display(4, 4, 'rand', 'desc')?>
